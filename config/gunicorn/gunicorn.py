...
)  # Reduced for gevent (more efficient)
worker_class = os.environ.get(
    "GUNICORN_WORKER_CLASS", "gevent"
)  # Changed from 'sync' to 'gevent'
worker_connections = int(
    os.environ.get("GUNICORN_WORKER_CONNECTIONS", "500")
...
# Performance tuning
preload_app = (
    os.environ.get("GUNICORN_PRELOAD_APP", "true").lower() == "true"
