...
from purplex.problems_app.models import (
    Problem, ProblemCategory, ProblemHint, ProblemSet, ProblemSetMembership,
...
class Command(BaseCommand):
    ...
    def _display_summary(self, counts, preserve_superuser):
        ...
        self.stdout.write(f'  • Problem Set Memberships: {counts["problem_set_memberships"]}')
        ...
        if preserve_superuser:
            ...
            self.stdout.write(f'  • All Users: {counts["users"]} (including {counts["superusers"]} superusers)')
    ...
    def _clear_all_data(self, dry_run, preserve_superuser):
        ...
        if preserve_superuser:
            ...
            self.stdout.write(f'  • Superusers: PRESERVED')
        else:
            if dry_run:
    ...
    def _display_results(self, deleted_counts):
        ...
        self.stdout.write('💡 Tip: Run "python manage.py createsuperuser" to create a new admin user')