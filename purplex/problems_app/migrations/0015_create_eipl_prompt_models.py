...
def migrate_eipl_prompt_data_forward(apps, schema_editor):
    ...
    with connection.cursor() as cursor:
        ...
        llm_config_expr = "COALESCE(llm_config, '{}')::jsonb" if has_llm_config else "'{}'::jsonb"
        cursor.execute(f"""
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Step 3: Migrate data
        migrations.RunPython(migrate_eipl_prompt_data_forward, migrate_eipl_prompt_data_reverse),
        ...
        migrations.RemoveField(model_name="problem", name="requires_highlevel_comprehension"),
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                migrations.CreateModel(
                    name="EiplProblem",
                    fields=[
                        ("problem_ptr", models.OneToOneField(
                            auto_created=True,
                        ...
                        ("segmentation_config", models.JSONField(blank=True, default=dict)),
                        ("segmentation_threshold", models.PositiveIntegerField(default=2)),
                        ("requires_highlevel_comprehension", models.BooleanField(default=True)),
                    ],
                    options={
