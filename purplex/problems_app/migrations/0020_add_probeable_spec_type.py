# Migration: Add ProbeableSpecProblem model
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("problems_app", "0019_add_probeable_code_type"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                # ProbeableSpecProblem-specific fields (same probe config as ProbeableCode)
                (
            ...
            options={
                "verbose_name": "Probeable Spec Problem",
                "verbose_name_plural": "Probeable Spec Problems",
            },
