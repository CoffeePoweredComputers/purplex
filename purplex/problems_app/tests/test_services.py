...
from ..services.docker_execution_service import (
...
class TestServiceIntegration(TestCase):
    ...
    def test_verbatim_validation_integration(self):
        ...
        self.assertTrue(
            service._validate_segment_is_verbatim(valid_segment, user_prompt)
        )
        self.assertFalse(
            service._validate_segment_is_verbatim(invalid_segment, user_prompt)
        )
