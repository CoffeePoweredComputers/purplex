...
from ..models import EiplProblem, ProblemCategory, ProblemHint
...
class ProblemHintModelTests(TestCase):
    ...
    def test_variable_fade_validation_missing_mappings(self):
        ...
        self.assertIn(
            "Variable fade hint must contain mappings", str(context.exception)
        )
    ...
    def test_variable_fade_validation_invalid_mapping_structure(self):
        ...
        self.assertIn(
            'Each mapping must have "from" and "to" fields', str(context.exception)
        )
    ...
    def test_subgoal_highlight_validation_missing_subgoals(self):
        ...
        self.assertIn(
            "Subgoal highlight hint must contain subgoals", str(context.exception)
        )
    ...
    def test_suggested_trace_validation_missing_suggested_call(self):
        ...
        self.assertIn(
            "Suggested trace hint must contain suggested_call", str(context.exception)
        )
    ...
    def test_edge_case_empty_content(self):
        ...
        hint = ProblemHint(
            problem=self.problem, hint_type="variable_fade", is_enabled=True, content={}
        )
