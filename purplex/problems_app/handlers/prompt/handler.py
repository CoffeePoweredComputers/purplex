...
class PromptHandler(ActivityHandler):
    ...
    def get_problem_config(self, problem: 'Problem') -> Dict[str, Any]:
        ...
        return {
            'display': {
                ...
                'image_alt_text': getattr(problem, 'image_alt_text', 'Problem image') or 'Problem image',
                'code_read_only': True,
    ...
    def get_admin_config(self) -> Dict[str, Any]:
        ...
        return {
            'hidden_sections': [],
            'required_fields': ['title', 'function_signature', 'reference_solution', 'image_url'],
            'optional_fields': ['image_alt_text', 'tags', 'categories', 'segmentation_config'],
