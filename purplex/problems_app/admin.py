...
class McqProblemChildAdmin(PolymorphicChildModelAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        return [
            ...
            if f.name not in ["options", "question_text", "is_active"]
        ] + ["categories"]
...
class ProblemAdmin(PolymorphicParentModelAdmin):
    ...
    def polymorphic_type_display(self, obj):
        """Display the polymorphic type as human-readable name."""
        # Use the model's verbose_name for display
    ...
    def edit_link(self, obj):
        if obj.slug:
            ...
            return format_html(
                '<a href="{}" target="_blank">Edit in Vue Admin →</a>', url
            )
        return "-"
...
class EiplProblemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("LLM Configuration", {"fields": ("llm_config",), "classes": ("collapse",)}),
        (
            "Segmentation",
            {
                "fields": (
...
class UserProgressAdmin(admin.ModelAdmin):
    ...
    def status_display(self, obj):
        colors = {"not_started": "gray", "in_progress": "orange", "completed": "green"}
        return format_html(
    ...
    def grade_display(self, obj):
        colors = {"complete": "green", "partial": "orange", "incomplete": "red"}
...
class UserProblemSetProgressAdmin(admin.ModelAdmin):
    ...
    list_filter = ["is_completed", "course", "problem_set", "last_activity"]

    search_fields = ["user__username", "user__email", "problem_set__title"]
