...
class CourseRepository(BaseRepository):
    ...
    @classmethod
    def create_enrollment(cls, user: User, course: Course, **kwargs) -> CourseEnrollment:
    ...
    @classmethod
    def update_or_create_enrollment(cls, user: User, course: Course, defaults: dict) -> tuple:
        ...
        return [
            {
                ...
                'problem_set': {
                    ...
                    'icon_url': cps.problem_set.icon.url if cps.problem_set.icon else None,
    ...
    @classmethod
    def get_course_problem_set(cls, course: Course, problem_set_slug: str) -> Optional[CourseProblemSet]:
    ...
    @classmethod
    def add_problem_set_to_course(cls, course: Course, problem_set, order: int = 0) -> CourseProblemSet:
    ...
    @classmethod
    def update_problem_set_order(cls, course: Course, problem_set, new_order: int) -> bool:
    ...
    @classmethod
    def get_courses_containing_problem_set(cls, problem_set_id: int) -> List[Dict[str, Any]]:
    ...
    def get_unassigned_problem_sets_for_course(cls, course_id: str) -> List[Dict[str, Any]]:
        ...
        problem_sets = ProblemSet.objects.filter(
            is_public=True
        ).exclude(id__in=assigned_ids).order_by('title')
