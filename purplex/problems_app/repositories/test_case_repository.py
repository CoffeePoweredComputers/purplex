...
class TestCaseRepository(BaseRepository):
    ...
    @classmethod
    def get_problem_test_cases(cls, problem: Problem, 
                              include_hidden: bool = True) -> List[TestCase]:
        """
    ...
    @classmethod
    def create_test_case(cls, problem: Problem, inputs: List, 
                        expected_output: Any, **kwargs) -> TestCase:
        """
    ...
    @classmethod
    def count_problem_test_cases(cls, problem: Problem, 
                                include_hidden: bool = True) -> int:
        """
    ...
    @classmethod
    def count_problem_test_cases_by_id(cls, problem_id: int, 
                                      include_hidden: bool = True) -> int:
        """
