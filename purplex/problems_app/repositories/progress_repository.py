...
class ProgressRepository(BaseRepository):
    ...
    def get_recent_activity(cls, user: User, days: int = 7) -> List:
        ...
        ).select_related('course').order_by('-last_attempt'))
    ...
    @classmethod
    def get_for_research_export(cls, course: Optional[Course] = None,
                               problem_set: Optional[ProblemSet] = None):
        """
    ...
    @classmethod
    def get_snapshots_for_research_export(cls, problem_set: Optional[ProblemSet] = None,
    ...
    @classmethod
    def get_problem_set_for_course_analytics(cls, course: Course, student_ids: List[int]):
        """
    ...
    def get_snapshots_for_student(cls, user: User, problem_sets, limit: int = 30):
        ...
        return ProgressSnapshot.objects.filter(
            user=user,
            problem_set__in=problem_sets
        ).order_by('snapshot_date')[:limit]

    @classmethod
    def get_for_problem_analytics(cls, course: Course, problem: Problem, student_ids: List[int]):
        """
    ...
    @classmethod
    def get_with_lock(cls, user: User, problem: Problem,
                     problem_set: Optional[ProblemSet],
                     course: Optional[Course], nowait: bool = True):
        """
        ...
        """
        return UserProgress.objects.select_for_update(nowait=nowait).filter(
            user=user,
            problem=problem,
            problem_set=problem_set,
            course=course,
    ...
    @classmethod
    def create_progress_record(cls, user: User, problem: Problem,
                              problem_set: Optional[ProblemSet],
                              course: Optional[Course],
                              problem_version: int) -> UserProgress:
        """
    ...
    @classmethod
    def get_with_lock_by_pk(cls, user: User, problem: Problem,
                           problem_set: Optional[ProblemSet],
                           course: Optional[Course], nowait: bool = True):
        """
    ...
    @classmethod
    def get_legacy_progress(cls, user: User, problem: Problem,
                           course: Optional[Course]):
        """
    ...
    @classmethod
    def update_or_create_snapshot(cls, user: User,
                                 problem: Problem,
                                 problem_set: Optional[ProblemSet],
                                 snapshot_date,
                                 defaults: Dict[str, Any]) -> tuple:
        """
