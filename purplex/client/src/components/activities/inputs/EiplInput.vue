 ...
 *
 * Self-contained component that owns its complete presentation.
 * Renders the inner content of the submission section.
 */
...
<style scoped>
/*
 * Styles extracted from ProblemSet.vue
 * EiplInput owns its complete presentation
 */

/* Section Header - matches ProblemSet.vue exactly */
.section-header {
  display: flex;
